...
class MindMapGenerator:
    ...
    def create_agent(self, role_name: str, initial_message: str) -> str:
        """
        Cria um agente na API OpenAI e obtém a resposta completa para uma mensagem inicial.
...
class FlashcardGenerator:
    ...
    utilizando a API da OpenAI para obter os dados dos flashcards.
    """
...
class EducationalAssistant:
    ...
    def __init__(self, api_key: str, model: str = "o4-mini"):
        ...
        Parâmetros:
            ...
            model (str): O modelo usado para gerar respostas (padrão: o4-mini).
        """
        self.client = OpenAI(api_key=api_key)
        self.model = model
